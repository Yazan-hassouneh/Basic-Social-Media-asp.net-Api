...
{
	public class NewFollowerNotificationProfile : BaseProfile
	{
		public NewFollowerNotificationProfile()
		{
			CreateMap<NewFollowerNotification, NewFollowerNotificationDto>()

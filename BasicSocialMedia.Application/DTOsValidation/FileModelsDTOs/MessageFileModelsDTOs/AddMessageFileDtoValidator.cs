...
{
	public class AddMessageFileDtoValidator : AbstractValidator<AddMessageFileDto>
	{
		public AddMessageFileDtoValidator(UserManager<ApplicationUser> userManager, ApplicationDbContext context)
		{

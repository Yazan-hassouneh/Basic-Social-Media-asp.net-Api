...
namespace BasicSocialMedia.Infrastructure.Migrations
{
    ...
    [Migration("20250506165609_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.AuthModels.UserBackgroundJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserBackgroundJobs", "Auth");
                });
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.CommentReactionNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CommentReactionNotifications", "Notification");
                });

            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.FriendRequestNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FriendRequestNotifications", "Notification");
                });

            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.NewCommentNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NewCommentNotifications", "Notification");
                });

            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.NewFollowerNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NewFollowerNotifications", "Notification");
                });

            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.PostReactionNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PostReactionNotifications", "Notification");
                });

            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.CommentReactionNotification", b =>
                {
                    ...
                    b.HasOne("BasicSocialMedia.Core.Models.Notification.UserNotification", "UserNotification")
                        .WithMany("CommentReactionNotifications")
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.NewFollowerNotification", b =>
                {
                    ...
                    b.HasOne("BasicSocialMedia.Core.Models.Notification.UserNotification", "UserNotification")
                        .WithMany("NewFollowerNotifications")
                        .HasForeignKey("UserNotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.PostReactionNotification", b =>
                {
                    ...
                    b.HasOne("BasicSocialMedia.Core.Models.Notification.UserNotification", "UserNotification")
                        .WithMany("PostReactionNotifications")
                        .HasForeignKey("UserNotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BasicSocialMedia.Core.Models.Notification.UserNotification", b =>
                {
                    b.Navigation("CommentReactionNotifications");

                    b.Navigation("FriendRequestNotifications");

                    b.Navigation("NewCommentNotifications");

                    b.Navigation("NewFollowerNotifications");

                    b.Navigation("PostReactionNotifications");
                });
